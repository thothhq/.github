...
- **AI Toolkit:** `hldg_jeannai/tooling/ai-toolkit/` -- skills, agent roles, workflow conventions
- **Catalog:** `hldg_jeannai/tooling/docs/source/reference/capability-catalog.rst`
